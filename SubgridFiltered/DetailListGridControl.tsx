...
export const DetailListGridControl: React.FC<IProps> = (props) => {             
    ...
    const [items, setItems] = React.useState(getItems(getColumns(props.pcfContext), props.pcfContext));
    ...
    const deleteLookup1_N = () => {
       ...
       /* ESTO ES PARA BORRAR EL REGISTRO ENTERO **/
        // _selectedDelete.forEach(element => {
        //     props.pcfContext.webAPI.deleteRecord(props.pcfContext.parameters.sampleDataSet.getTargetEntityType(),element).then(
        ...
        //       );
        // });
         /* ESTO ES PARA BORRAR EL Lookup solo **/
        // _selectedDelete.forEach(element => {
        //     props.pcfContext.webAPI.updateRecord(props.pcfContext.parameters.sampleDataSet.getTargetEntityType(), element,{"pro_paquetedelcontrato@odata.bind":"/pro_paquetedelcontratos(00000000-0000-0000-0000-000000000000)"}).then(
        //         function(response: any) {
